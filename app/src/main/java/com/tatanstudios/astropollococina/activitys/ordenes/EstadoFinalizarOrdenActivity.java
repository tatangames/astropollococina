...
import com.tatanstudios.astropollococina.adaptadores.ordenes.ProductoFinalizarOrdenAdapter;
...
public class EstadoFinalizarOrdenActivity extends AppCompatActivity {
    ...
    ProductoFinalizarOrdenAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_estado_finalizar_orden);

        txtOrdenNum = findViewById(R.id.txtnumorden);
        ...
        adapter = new ProductoFinalizarOrdenAdapter();
        ...
        txtOrdenNum.setText("Orden #" + idOrden);
    ...
    void peticionFinalizarOrden(){

        progressBar.setVisibility(View.VISIBLE);
        compositeDisposable.add(
                service.finalizarOrden(idOrden)
                        ...
                        .subscribe(apiRespuesta -> {
                                    ...
                                    if(apiRespuesta != null) {
                                        ...
                                        if(apiRespuesta.getSuccess() == 1){
                                            ...
                                            alertaMensajeWarning(apiRespuesta.getTitulo(), apiRespuesta.getMensaje());
                                        }
                                        if(apiRespuesta.getSuccess() == 2){

                                            // ORDEN FINALIZADA

                                            alertaMensajeSuccess(apiRespuesta.getTitulo(), apiRespuesta.getMensaje());
    ...
    void alertaMensajeSuccess(String titulo, String mensaje){
    ...
    void alertaMensajeWarning(String titulo, String mensaje){
                ...
                service.verListadoDeProductosOrden(idOrden)
                        ...
                        .subscribe(apiRespuesta -> {
                                    ...
                                    if(apiRespuesta != null) {
                                        ...
                                        if(apiRespuesta.getSuccess() == 1){
                                            adapter = new ProductoFinalizarOrdenAdapter(getApplicationContext(), apiRespuesta.getProductos(), this);
                                            recyclerProductos.setAdapter(adapter);
