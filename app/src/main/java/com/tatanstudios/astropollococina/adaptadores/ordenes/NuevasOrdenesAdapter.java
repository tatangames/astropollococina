...
public class NuevasOrdenesAdapter extends RecyclerView.Adapter<NuevasOrdenesAdapter.MyViewHolder> {
    ...
    @NonNull
    @Override
    public NuevasOrdenesAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull NuevasOrdenesAdapter.MyViewHolder holder, int position) {
