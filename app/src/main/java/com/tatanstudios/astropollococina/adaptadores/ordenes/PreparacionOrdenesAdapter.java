...
public class PreparacionOrdenesAdapter extends RecyclerView.Adapter<PreparacionOrdenesAdapter.MyViewHolder> {

    // carga los servicios por zona

    Context context;
    List<ModeloOrdenesList> modeloTipo;
    FragmentOrdenEnPreparacion fTipoServicio;

    public PreparacionOrdenesAdapter(){}

    public PreparacionOrdenesAdapter(Context context, List<ModeloOrdenesList> modeloTipo, FragmentOrdenEnPreparacion fTipoServicio){
    ...
    @NonNull
    @Override
    public PreparacionOrdenesAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(context)
                .inflate(R.layout.cardview_preparacion_ordenes, parent, false);
        return new PreparacionOrdenesAdapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull PreparacionOrdenesAdapter.MyViewHolder holder, int position) {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public MyViewHolder(View itemView){
            ...
            textoPremio = itemView.findViewById(R.id.txtS7);
