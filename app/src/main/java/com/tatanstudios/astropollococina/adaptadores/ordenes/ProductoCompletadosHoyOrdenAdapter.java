...
import com.tatanstudios.astropollococina.activitys.ordenes.EstadoProductosListadoActivity;
...
public class ProductoCompletadosHoyOrdenAdapter extends RecyclerView.Adapter<ProductoCompletadosHoyOrdenAdapter.MyViewHolder>  {

    Context context;
    public ArrayList<ModeloProductoList> modeloTipo;
    EstadoProductosListadoActivity estadoProductosListadoActivity;
    ...
    public ProductoCompletadosHoyOrdenAdapter(){}

    public ProductoCompletadosHoyOrdenAdapter(Context context, ArrayList<ModeloProductoList>  modeloTipo, EstadoProductosListadoActivity estadoProductosListadoActivity){
        this.context = context;
        this.modeloTipo = modeloTipo;
        this.estadoProductosListadoActivity = estadoProductosListadoActivity;
    }

    @NonNull
    @Override
    public ProductoCompletadosHoyOrdenAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull ProductoCompletadosHoyOrdenAdapter.MyViewHolder holder, int position) {
        ...
        holder.setListener((view, position1) -> {
            ...
            estadoProductosListadoActivity.verProductoIndividual(id);
        });
    }
