...
import com.tatanstudios.astropollococina.adaptadores.ordenes.CanceladasHoyOrdenesAdapter;
...
public class FragmentCanceladasHoy extends Fragment {
    ...
    CanceladasHoyOrdenesAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View vista = inflater.inflate(R.layout.fragment_canceladas_hoy_ordenes, container, false);


        ((PrincipalActivity)getActivity()).setActionBarTitle(getString(R.string.canceladas_hoy));
        ...
        adapter = new CanceladasHoyOrdenesAdapter();
    ...
    void peticionServidor(){
        ...
        compositeDisposable.add(
                service.verCanceladasHoyOrdenes(id)
                        ...
                        .subscribe(apiRespuesta -> {
                                    ...
                                    if(apiRespuesta != null) {
                                        ...
                                        if(apiRespuesta.getSuccess() == 1){
                                            ...
                                            adapter = new CanceladasHoyOrdenesAdapter(getContext(), apiRespuesta.getOrdenes(), this);
                                            recyclerOrdenes.setAdapter(adapter);
    ...
    public void abrirOrdenes(int ordenid){
        Intent res = new Intent(getActivity(), EstadoProductosListadoActivity.class);
